                ...
                <div class="container contenedor-card">
                    ...
                    <div class="row justify-content-center g-3">
                        ...
                        <?php foreach ($productos as $producto) { ?>
                            <div class="row borde">
                                <div class="col-md-1">
                                    <h5 class="card-title text-center"><?php echo $producto['titulo']; ?></h5>
                                    <img src="<?php echo $producto['imagen']; ?>" class="img-tamanio-biblioteca d-block mx-auto" alt="...">
                                </div>
                                <div class="col-md-1 border-end">
                                </div>
                                <div class="col-md-1">
                                    <button type="button" class="btn btn-outline-warning">JUGAR</button>
                                </div>
                            </div>
                            <div>
